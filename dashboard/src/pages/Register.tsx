...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    setSubmitting(true)
    try {
      await registerOrg(companyName, ownerName, email, password)
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gray-50 px-4 py-10">
      <div className="w-full max-w-sm bg-white border border-gray-100 rounded-xl p-8 shadow-sm">
        ...
        <h1 className="text-xl font-semibold text-gray-900 mb-1">Register your company</h1>
        <p className="text-sm text-gray-500 mb-6">Create your organization workspace</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            <label className="block text-sm text-gray-700 mb-1.5">Your name</label>
            <input
              required
              value={ownerName}
